...
public class Artwork_UkeAndTubaPage  extends Base {

	public Artwork_UkeAndTubaPage(WebDriver driver){
		super(driver);
	}
	...
	public void lookForPageTitle() {
		...
		CoreFunctions.explicitWaitTillElementVisibility(driver, _postTitle, "Uke and Tuba Discography", 60);
	}
